...
# <a href="https://leetcode.com/problems/intersection-of-two-linked-lists/" target="_blank">00160-intersection-of-two-linked-lists</a>
...
public:
    ListNode *getIntersectionNode(ListNode *headA, ListNode *headB) {
        ...
        while (p1 && p2 && p1 != p2) {
            ...
            // first iteration will not be the same (HEAD)
            p1 = p1->next;
            p2 = p2->next;
